module yab::errors {
    ...
    const E_WITHDRAW_INSUFFICIENT_LIQUIDITY: u64 = 33; // unable to realize owed amount during withdraw
    // strategy
    ...
    public fun withdraw_insufficient_liquidity(): u64 { E_WITHDRAW_INSUFFICIENT_LIQUIDITY }
